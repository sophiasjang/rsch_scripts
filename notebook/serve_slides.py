...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Serve ipython notebook slides manually.')
    parser.add_argument('--reveal-prefix', help="specify path to reveal.js folder", metavar="path/to/reveal.js", default="")
    parser.add_argument('path', metavar='file', help="path to html file to serve")
    
    args = parser.parse_args(sys.argv[1:])
    main(args.path, args.reveal_prefix)